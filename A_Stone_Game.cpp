...
int main()
{
    ...
    while (t--)
    {
        ...
        int maxPos = max_element(vt.begin(), vt.end()) - vt.begin();
        int minPos = min_element(vt.begin(), vt.end()) - vt.begin();
        int alpha = max(maxPos, minPos) + 1;
        int beta = (n - 1) - min(maxPos, minPos) + 1;
        int gamma = (n - 1) - maxPos + minPos + 2;
        int delta = (n - 1) - minPos + maxPos + 2;
        cout << min(alpha, min(beta, min(delta, gamma))) << "\n";
    }
}